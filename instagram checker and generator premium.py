...
print("Instagram Account Generator And Checker 1.0")
import random
import string
import time
import requests
...
def check_account_validity(email, password):
    url = "https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjug5qD47qFAxVWX_EDHU-3AaYQFnoECAYQAQ&url=https%3A%2F%2Fwww.instagram.com%2Faccounts%2Flogin%2F%3Fhl%3Den&usg=AOvVaw22wbeKu9CbUP9Ki54NoHiP&opi=89978449 "
    headers = {
